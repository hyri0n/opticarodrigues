...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="index.php" class="w3-bar-item w3-button w3-padding w3-teal"><i class="fa fa-users fa-fw"></i>  Clientes</a>
    <a href="mensalidades.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-money"></i>  Mensalidades</a><br><br>
  </div>
</nav>
      ...
      ?>
        ...
        <div id="id01" class="w3-modal">
          <div class="w3-modal-content w3-card-4 w3-animate-zoom w3-light-grey w3-border w3-round-large" style="max-width:600px">
            ...
            <form class="w3-container" action="acoes_cliente.php?cad=true" method="post">
              <div class="w3-section">
              <label><b>OS</b></label>
                <input class="w3-input w3-border-grey w3-round-small w3-margin-bottom" type="text" placeholder="OS do Cliente" name="os" required>
                <label><b>Nome</b></label>
                <input class="w3-input w3-border-grey w3-round-small w3-margin-bottom" type="text" placeholder="Nome do Cliente" name="nome" required>
                <label><b>CPF</b></label>
                <input class="w3-input w3-border-grey w3-round-small w3-margin-bottom" type="text" placeholder="CPF" name="cpf" pattern="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}" required>
                <label><b>Endereço</b></label>
                <input class="w3-input w3-border-grey w3-round-small w3-margin-bottom" type="text" placeholder="Endereço" name="endereco" required>
                <label><b>Telefone</b></label>
                <input class="w3-input w3-border-grey w3-round-small" type="tel" placeholder="Telefone" name="telefone" pattern="[0-9]{5}-[0-9]{4}" required>
        ...
        <?php
        include_once "conexao.php";
        $stmt = $conn-> query ('SELECT * FROM clientes ORDER BY nome ASC');
        ?>

        <div class="w3-container">
          <header class="w3-container w3-teal w3-round-small">
           <span><i class="fa fa-users fa-fw"></i>  <strong class="w3-large">Clientes</strong></span>
           ...
           <span><input type="text" id="myInput" onkeyup="myFunctionShow()" placeholder="Buscar Por Nome do Cliente..."></span>
          </header>
          ...
          ?>
              <tr>
                ...
                <td class="w3-center"> <?php  echo "<a href=editar_cliente.php?editar=".$linha['os']."><i class='material-icons' style='color:teal'>build</i></a>"; ?> </td>
                <td class="w3-center"> <?php  echo "<a href=acoes_cliente.php?del=".$linha['os']."><i class='material-icons' style='color:teal'>delete</i></a>"; ?> </td>
                <td class="w3-center"> <?php  echo "<a href=mensalidadecliente.php?consultar=".$linha['os']."><i class='material-icons' style='color:teal'>person</i></a>"; }?></td> 
              </tr>
          </table>
          </div>
        </div>
